...
if exists(Template(r"tpl1574058712020.png", record_pos=(0.005, -0.183), resolution=(1440, 2560))):
    touch(Template(r"tpl1574058712020.png", record_pos=(0.005, -0.183), resolution=(1440, 2560)))
    sleep(30)
