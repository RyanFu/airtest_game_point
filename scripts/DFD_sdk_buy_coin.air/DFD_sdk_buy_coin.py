...
if exists(Template(r"tpl1574062951883.png", record_pos=(0.003, -0.042), resolution=(1440, 2560))):
    touch(Template(r"tpl1574062951883.png", record_pos=(0.003, -0.042), resolution=(1440, 2560)))
    sleep(10)
    if exists(Template(r"tpl1574063071643.png", record_pos=(-0.228, -0.069), resolution=(1440, 2560))):
        poco.click([0.27,0.36])
        sleep(3)
        touch(Template(r"tpl1574063071643.png", record_pos=(-0.228, -0.069), resolution=(1440, 2560)))
        sleep(3)
        text("ayw.su@yandex.com")
        touch(Template(r"tpl1574063314161.png", record_pos=(-0.198, 0.068), resolution=(1440, 2560)))
        sleep(3)
        text("ayw123456")
        sleep(3)
        touch(Template(r"tpl1574063348096.png", record_pos=(-0.03, 0.212), resolution=(1440, 2560)))
        sleep(30)
