...
#登录
if login_mode=='local':
    if exists(Template(r"tpl1574649831093.png", record_pos=(-0.046, -0.02), resolution=(2560, 1440))):
        poco.click([0.75,0.86])
        sleep(10)
else:
...
while True:
    if exists(Template(r"tpl1572229675665.png", record_pos=(0.341, -0.194), resolution=(2160, 1080))):
        ...
        sleep(3)
    elif exists(Template(r"tpl1572242422086.png", record_pos=(0.003, 0.195), resolution=(1920, 1080))):
...
if exists(Template(r"tpl1572229786058.png", record_pos=(-0.022, -0.213), resolution=(2160, 1080))):
    ...
    sleep(5)
    if exists(Template(r"tpl1574649662979.png", record_pos=(-0.359, 0.154), resolution=(2560, 1440))):
        touch(Template(r"tpl1574649662979.png", record_pos=(-0.359, 0.154), resolution=(2560, 1440)))
        sleep(15)
        poco.click([0.5,0.9])
        sleep(20)
        i=5
